// scripts/migrate.js — idempotent schema + seed for production deploys.
// Runs at app startup so a fresh Render deploy bootstraps itself.
...
async function migrate() {
  ...
  // Non-fatal: if iTunes is down, existing rows with previews still play.
  try {
